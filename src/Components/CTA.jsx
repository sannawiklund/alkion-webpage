...
function AboutUs() {
    return (
        <section className="bg-gradient-to-r from-gray-900 to-sky-900 py-24 relative text-center">
                ...
                <div className="w-full justify-center items-center grid lg:grid-cols-1 grid-cols-1">
                    <div className="w-full flex-col justify-center items-center gap-2 inline-flex">
                        <div className="w-full flex-col justify-center items-center gap-3 flex">
                            ...
                            <button className="sm:w-fit w-full px-3.5 py-2 bg-[#3daf36] hover:bg-[#3e883a] transition-all duration-700 ease-in-out shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
